...
{
    public sealed class KomachiModUltShootGhostsDef : KomachiUltTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModUltShootGhostsDef))]
    public sealed class KomachiModUltShootGhosts : UltimateSkill
    {
        public KomachiModUltShootGhosts()
        {
