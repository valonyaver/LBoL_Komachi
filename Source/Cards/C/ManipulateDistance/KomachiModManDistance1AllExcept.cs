...
{
    public sealed class KomachiModManDistance1AllExceptDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModManDistance1AllExceptDef))]
    public sealed class KomachiModManDistance1AllExcept : KomachiCard 
    {
        /// <summary>
