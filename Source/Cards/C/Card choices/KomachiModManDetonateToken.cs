...
{
    public sealed class KomachiModManDetonateTokenDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModManDetonateTokenDef))]
    public sealed class KomachiModManDetonateToken : KomachiCard
    {
