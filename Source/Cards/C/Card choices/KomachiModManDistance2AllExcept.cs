...
{
    public sealed class KomachiModManDistance2AllExceptDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModManDistance2AllExceptDef))]
    public sealed class KomachiModManDistance2AllExcept : KomachiCard 
    {
        /// <summary>
