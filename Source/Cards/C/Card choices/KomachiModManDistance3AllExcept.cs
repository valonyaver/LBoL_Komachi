...
{
    public sealed class KomachiModManDistance3AllExceptDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModManDistance3AllExceptDef))]
    public sealed class KomachiModManDistance3AllExcept : KomachiCard 
    {
        /// <summary>
