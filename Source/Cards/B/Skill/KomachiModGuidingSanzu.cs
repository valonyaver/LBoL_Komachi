...
namespace KomachiMod.Cards
{
    ...
    /// </summary>
    public sealed class KomachiModGuidingSanzuDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModGuidingSanzuDef))]
    public sealed class KomachiModGuidingSanzu : KomachiCard
    {
