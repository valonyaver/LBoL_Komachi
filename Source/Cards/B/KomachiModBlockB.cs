...
{
    public sealed class KomachiModBlockBDef : KomachiCardTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModBlockBDef))]
    public sealed class KomachiModBlockB : KomachiCard
    {
