...
{
    public sealed class KomachiModAttackBDef : KomachiCardTemplate
    {
        public override CardConfig MakeConfig()
        {
            CardConfig config = GetCardDefaultConfig();
            config.GunName = GunNameID.GetGunFromId(824);
    ...
    [EntityLogic(typeof(KomachiModAttackBDef))]
    public sealed class KomachiModAttackB : KomachiCard
    {
