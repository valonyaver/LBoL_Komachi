...
{
    public sealed class KomachiModAttackRDef : KomachiCardTemplate
    {
        public override CardConfig MakeConfig()
        {
            CardConfig config = GetCardDefaultConfig();
            config.GunName = GunNameID.GetGunFromId(444002);
    ...
    [EntityLogic(typeof(KomachiModAttackRDef))]
    public sealed class KomachiModAttackR : KomachiCard
    {
