...
namespace KomachiMod.StatusEffects
{
    ...
    public sealed class KomachiModLonelyBoundSpiritSe : StatusEffect
    {
        ...
        {
            base.HandleOwnerEvent<ApplyVengefulSpiritEventArgs>
                (KomachiEventsManager.AppliedVengefulSpirit, new GameEventHandler<ApplyVengefulSpiritEventArgs>(this.OnApplyVengefulSpirit));
            base.HandleOwnerEvent<DetonateVengefulSpiritEventArgs>
                (KomachiEventsManager.DetonatedSpirits, new GameEventHandler<DetonateVengefulSpiritEventArgs>(this.OnDetonatingVengefulSpirits), GameEventPriority.Highest);
        }
