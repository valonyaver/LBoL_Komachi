...
namespace KomachiMod.StatusEffects
{
    ...
    public sealed class KomachiDetonationKeywordDef : KomachiStatusEffectTemplate
    {
    ...
    [EntityLogic(typeof(KomachiDetonationKeywordDef))]
    public sealed class KomachiDetonationKeyword : StatusEffect
    {
    }
}
