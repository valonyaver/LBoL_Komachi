...
{
    public sealed class KomachiModBossGuidedEndTurnSeDef : KomachiStatusEffectTemplate
    {
    ...
    [EntityLogic(typeof(KomachiModBossGuidedEndTurnSeDef))]
    public sealed class KomachiModBossGuidedEndTurnSe : StatusEffect
    {
